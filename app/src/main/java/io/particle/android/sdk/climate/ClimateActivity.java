...
import io.particle.android.sdk.climate.ClimateActivityFragment;
 ...
 * more than a {@link ClimateActivityFragment}.
 */
public class ClimateActivity extends BaseActivity {


    public static Intent buildIntent(Context ctx, ParticleDevice device) {
        return new Intent(ctx, ClimateActivity.class)
                .putExtra(ClimateActivityFragment.ARG_DEVICE, device);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ParticleDevice device = getIntent().getParcelableExtra(ClimateActivityFragment.ARG_DEVICE);
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(R.id.device_detail_container, ClimateActivityFragment.newInstance(device))
                    .commit();
        }
    }
