...
import io.particle.android.sdk.blinds.BlindsActivity;
import io.particle.android.sdk.climate.ClimateActivity;
...
//                    .setActivateOnItemClick(true);
    ...
    @Override
    public void onDeviceSelected(@NonNull ParticleDevice device,@NonNull String deviceType) {
        // FIXME: re-enable
//
//        return;
//
...
//        } else {
        ...
        else if(deviceType.equals("climate")){
            startActivity(ClimateActivity.buildIntent(this, device));
        }
//        }
    }
    //endregion
